import os
import shutil
from voice_identification.VI.Tools import Data
from voice_identification.VI.Tools import VI_Model
from voice_identification.VI.Tools import Predictor
from voice_identification.VI import Container
import time
import warnings
# import VI.VI.VI.tensorflow as tf
...
def start(getDIR):
    ...
    mainPath = os.path.dirname(os.path.realpath(__file__)) + "\\VI"
